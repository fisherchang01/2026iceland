    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .header-title { font-size: var(--fs-md); font-weight: 700; color: var(--primary); font-family: var(--font-display);}
    .header-sub   { font-size: var(--fs-xs); color: var(--sub); margin-top: var(--sp-1); }
    .bottom-nav {
      position: fixed;
    ...
    .nav-dot { width: 4px; height: 4px; background: var(--primary); border-radius: 50%; opacity: 0; margin-top: var(--sp-1); }
    ...
    .trip-banner-left h1 { font-size: var(--fs-md); font-weight: 700; line-height: 1.4; font-family: var(--font-display);}
    .trip-banner-left p  { font-size: var(--fs-xs); opacity: 0.75; margin-top: var(--sp-1); }
    .trip-banner-right {
      display: flex;
      flex-direction: column;
    ...
    .day-card:hover  { box-shadow: 0 4px 16px rgba(0,0,0,0.1); background: #eeeeea !important; }
    .day-badge {
      border-radius: var(--radius-sm);
    ...
    .day-card.c0 .day-badge { background: #6a7a8a; color:#fff; }
    .day-card.c1 .day-badge { background: #3a9a78; color:#fff; }
    .day-card.c2 .day-badge { background: #4a6fcf; color:#fff; }
    .day-card.c3 .day-badge { background: #d4783a; color:#fff; }
    .day-card.c4 .day-badge { background: #8a4abf; color:#fff; }
    .day-card.c5 .day-badge { background: #b89a20; color:#fff; }
    .day-card.c6 .day-badge { background: #2a90ba; color:#fff; }
    .day-card.c7 .day-badge { background: #c05a3a; color:#fff; }
    .day-card.c8 .day-badge { background: #5a9a3a; color:#fff; }
    .day-badge .month { font-size: var(--fs-2xs); opacity: 0.85; letter-spacing: 1px; }
    .day-badge .date  { font-size: var(--fs-lg); font-weight: 700; line-height: 1.1; }
    .day-card-info { flex: 1; }
    .day-card-info h3 { font-size: var(--fs-base); font-weight: 700; color: var(--text); }
    .day-card-info p  { font-size: var(--fs-xs); color: var(--sub); margin-top: var(--sp-1); line-height: 1.5; }
    ...
    .day-card-arrow { color: var(--sub); flex-shrink: 0; opacity: 0.5; padding-top: 2px; }
    .day-card-arrow svg { width: 16px; height: 16px; }
    .day-hero {
      background: linear-gradient(135deg, #2c5f6e 0%, #1a3d4a 100%);
      border-radius: var(--radius);
      padding: var(--sp-7) var(--sp-7);
    ...
    .day-hero-label { font-size: var(--fs-2xs); letter-spacing: 2px; opacity: 0.7; text-transform: uppercase; }
    .day-hero-title { font-size: var(--fs-lg); font-weight: 700; margin-top: var(--sp-1); font-family: var(--font-display);}
    .day-hero-date  { font-size: var(--fs-xs); opacity: 0.75; margin-top: var(--sp-1); }
    .spot-list-label {
    ...
    .spot-item:active { transform: scale(0.98); }
    .spot-item:hover  { box-shadow: 0 4px 16px rgba(44,95,110,0.1); }
    .spot-item.no-click { cursor: default; }
    ...
    .spot-item-info { flex: 1; padding: var(--sp-4) var(--sp-5); }
    .spot-item-info h4 { font-size: var(--fs-base); font-weight: 600; }
    .spot-item-info p  { font-size: var(--fs-xs); color: var(--sub); margin-top: var(--sp-1); }
    .spot-item-arrow { padding-right: 12px; color: var(--sub); flex-shrink: 0; }
    .spot-item-arrow svg { width: 16px; height: 16px; }
    .drive-connector {
      display: flex;
      align-items: center;
      gap: var(--sp-3);
    ...
    .drive-dot { width: 6px; height: 6px; border-radius: 50%; background: var(--accent-soft); }
    .drive-dashed { width: 2px; height: 20px; border-left: 2px dashed var(--accent-soft); }
    .drive-info {
      display: flex;
      align-items: center;
      gap: var(--sp-2);
    ...
    .spot-hero-sub   { font-size: var(--fs-xs); opacity: 0.75; margin-top: var(--sp-1); }
    .spot-img-wrap {
    ...
    .info-card p { font-size: var(--fs-sm); line-height: 1.8; color: #3a3a3a; }
    .tips-card {
    ...
    .tips-card p { font-size: var(--fs-sm); line-height: 1.8; color: var(--warn-txt); }
    .parking-card {
      background: #f8f4e8;
    ...
    .next-stop-icon { font-size: var(--fs-lg); flex-shrink: 0; }
    ...
    .hotel-map-btn {
      padding: var(--sp-5);
      font-size: var(--fs-base);
      background: linear-gradient(135deg, #4a8fa3, #2c5f6e);
    }
    .hotel-map-btn:hover { background: linear-gradient(135deg, #3a7f93, #1a4f5e); }
    .flight-segment {
      background: var(--card);
      border: 1px solid var(--border);
      border-radius: var(--radius-sm);
    ...
    .station-grid, .market-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: var(--sp-3); }
    .station-card, .market-card {
      background: var(--card);
      border: 1px solid var(--border);
      border-radius: var(--radius);
      padding: var(--sp-5);
    ...
    .station-icon, .market-icon { font-size: var(--fs-2xl); display: block; margin-bottom: var(--sp-2); }
    .station-card h4, .market-card h4 { font-size: var(--fs-sm); font-weight: 700; color: var(--text); }
    .station-card p, .market-card p { font-size: var(--fs-xs); color: var(--sub); margin-top: var(--sp-1); line-height: 1.5; }
    .price { color: var(--success) !important; font-weight: 700; font-size: var(--fs-sm) !important; }
    .market-tag { display: inline-block; background: var(--tag-bg); color: var(--tag-txt); border-radius: var(--radius-sm); padding: var(--sp-1) var(--sp-3); font-size: var(--fs-2xs); font-weight: 600; margin-top: var(--sp-1); }
    ...
    .souvenir-img-wrap { width: 100%; height: 160px; overflow: hidden; background: var(--bg2); display: flex; align-items: center; justify-content: center; }
    .souvenir-img-wrap img { width: 100%; height: 100%; object-fit: cover; }
    .souvenir-img-wrap .img-fallback { font-size: var(--fs-4xl); display: flex; align-items: center; justify-content: center; width: 100%; height: 100%; }
    .souvenir-info { padding: var(--sp-5) var(--sp-6); }
    .souvenir-info h4 { font-size: var(--fs-base); font-weight: 700; color: var(--text); margin-bottom: var(--sp-1); }
    ...
    .souvenir-item:last-child { margin-bottom: 0; }
    .souvenir-img-wrap.small { width: 64px; height: 64px; flex-shrink: 0; border-radius: var(--radius-sm); overflow: hidden; }
    .souvenir-img-wrap.small img { width: 100%; height: 100%; object-fit: cover; }
    .souvenir-img-wrap.small .img-fallback { font-size: var(--fs-2xl); width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; background: var(--bg2); }
    .souvenir-item-info { flex: 1; }
    .souvenir-item-info h4 { font-size: var(--fs-sm); font-weight: 700; color: var(--text); margin-bottom: var(--sp-1); }
    .souvenir-item-info p { font-size: var(--fs-xs); color: var(--sub); line-height: 1.5; margin-bottom: var(--sp-1); }
    ...
    .area-label {
      ...
      text-transform: uppercase;
      font-weight: 600;
      margin: var(--sp-5) 0 var(--sp-2) var(--sp-1);
      display: flex;
      align-items: center;
      gap: var(--sp-2);
    }
    ...
    .spot-sheet-scroll {
      ...
      padding: 0 var(--sp-8) var(--sp-9);
    }
    @media (max-width: 380px) {
      .spot-sheet-scroll { padding: 0 var(--sp-7) var(--sp-9); }
    }
