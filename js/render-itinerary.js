...
function handleSpotImgError(imgEl, icon) {
  imgEl.parentElement.innerHTML = '<div class="img-fallback"><span class="fallback-icon">' + icon + '</span><span class="fallback-label">插画示意</span></div>';
}
function buildSpotImageHtml(s) {
  var fallback = '<div class="img-fallback"><span class="fallback-icon">' + s.icon + '</span><span class="fallback-label">插画示意</span></div>';
  if (s.img) {
