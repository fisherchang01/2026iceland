...
//
// ★ 景點照片（新功能）：
// 每個景點物件可以加一個 img 欄位，例如：img: 'thingvellir.jpg'
// 圖片檔案要放在 images/spots/ 這個資料夾裡，檔名要跟 img 欄位寫的完全一樣（含副檔名）。
// 沒有寫 img 欄位、或圖片檔案不存在，網站都會自動顯示插畫代替，不會出現「圖片壞掉」的畫面，
...
const TRIP = {
  ...
  day1: {
    num:'1', dateLabel:'10月4日（周日）', title:'黄金圈',
    driveSummary: { total:'约 75 km', time:'约 60 分钟（不含景点停留）' },
    hotel:{ name:'South Central Country Apartment 民宿', note:'黄金圈地区，舒适乡村民宿环境', map:'South Central Country Apartment Iceland' },
    spots: [
      { icon:'🏞️', name:'Þingvellir 辛格维利尔国家公园', tags:['世界遗产','国家公园','地质奇观'],
        desc:'冰岛最早的露天议会旧址，同时也是北美板块与欧亚板块的交界裂谷带，可沿步道走在两大板块之间。',
        deepDesc:'辛格维利尔于2004年列入世界遗产，素有「世界最古老的民主议会会址」之称——早在公元930年，维京人就曾在这里集会议事。更神奇的是，你脚下踩着的正是北美板块与欧亚板块的交接裂谷，两大陆地每年仍以约2公分的速度缓缓分离。',
        ...
        nextStop:{ type:'drive', text:'🚗 前往 Geysir', detail:'约 60 km · 约 50 分钟' } },
      { icon:'💦', name:'Geysir 盖歇尔地热区', tags:['地热','喷泉'],
        desc:'区内的 Strokkur 间歇泉每隔数分钟便会喷发一次，水柱可高达十余米，周边还有多处地热池。',
        deepDesc:'蓋錫爾間歇泉曾是世界上最壯觀的間歇泉。雖然因人為因素造成阻塞，目前大蓋錫爾已停止噴發，但一旁的斯特羅柯間歇泉（Strokkur）每隔5至10分鐘便會規律噴發，水柱直衝天際的瞬間依然令人屏息。建議和旅伴輪流錄影，才能同時捕捉到噴發的壯觀與彼此驚喜的表情。',
      ...
      { icon:'🌊', name:'Gullfoss 黄金瀑布', tags:['瀑布','必访'],
        desc:'冰岛最具代表性的瀑布之一，河水分两层跌入峡谷，水量丰沛气势磅礴，晴天时常见彩虹。',
        deepDesc:'古佛斯黄金瀑布（Gullfoss）是黄金圈名称的由来，也是冰岛最具代表性的自然奇观之一。倾泻而下的瀑布溅起的水珠弥漫在天空，在阳光照射下形成道道彩虹，彷佛整个瀑布是用金子锻造成的。当年有人不惜牺牲一切也要保护这座瀑布不被水力发电厂破坏，可见其珍贵。',
        tips:'上、下两层观景台都值得走，木栈道靠近瀑布处湿滑，请留意脚下。',
        parking:'1000 ISK（Parka app）；部分资料亦称免费，建议现场确认。',
        toilet:'游客中心内。',
        map:'Gullfoss Iceland',
        nextStop:{ type:'drive', text:'🚗 前往 Selfoss 超市', detail:'约 70 km · 约 55 分钟' } },
      { icon:'🛒', name:'Selfoss 超市采购', tags:['超市','补给'], isShop:true,
        desc:'Selfoss 是南部重要城镇，建议在此于 Bónus 或 Krónan 补齐接下来两天的粮食与日用品，离开后超市越来越少。',
        tips:'建议在 Bónus 小猪超市采购，价格最实惠。鱼罐头、乳制品、零食可在此备足。',
        map:'Bonus Selfoss Iceland',
        nextStop:{ type:'drive', text:'🚗 前往民宿', detail:'约 15 km · 约 15 分钟' } }
    ],
    drives:[
      { from:'Þingvellir', to:'Geysir', dist:'约 60 km', time:'约 50 分钟' },
      { from:'Geysir', to:'Gullfoss', dist:'约 10 km', time:'约 10 分钟' },
      null,
      null
    ]
  },
  day2: {
    num:'2', dateLabel:'10月5日（周一）', title:'黄金圈深度',
    driveSummary: { total:'约 90 km', time:'约 75 分钟（不含景点停留）' },
    hotel:{ name:'South Central Country Apartment 民宿', note:'连住，黄金圈地区', map:'South Central Country Apartment Iceland' },
    spots: [
      { icon:'💎', name:'Brúarfoss 蓝钻石瀑布', tags:['瀑布','秘境'],
        desc:'以水色闻名的瀑布，河水因玄武岩地质呈现梦幻蓝绿色，需徒步约 20–30 分钟抵达。',
        deepDesc:'Brúarfoss 被誉为「蓝钻石瀑布」，是冰岛黄金圈一带的隐藏版秘境。河流因流经玄武岩地质，折射出梦幻的蓝绿色调，在阳光下闪烁如碎钻般的光芒。正是这段不长不短的徒步，过滤了大部分观光客，让你和旅伴能独享这片静谧的蓝色奇迹。',
        tips:'步道路面不平整，建议穿防滑鞋，可视体力评估是否全程走完。',
        parking:'750 ISK（Parka app），停车场步行约 5 分钟。',
        toilet:'无。出发前请在民宿解决。',
        map:'Bruarfoss Iceland',
        nextStop:{ type:'drive', text:'🚗 前往 Kerið', detail:'约 45 km · 约 40 分钟' } },
      { icon:'🌀', name:'Kerið 火山口湖', tags:['火山口','湖泊'],
    ...
    drives:[
      { from:'Brúarfoss', to:'Kerið', dist:'约 45 km', time:'约 40 分钟' },
      null
    ]
  },
  day3: {
    ...
    spots: [
      { icon:'💧', name:'Seljalandsfoss', tags:['瀑布','可走入水帘后'],
      ...
      { icon:'🏔️', name:'Skógafoss', tags:['瀑布','登高观景'],
      ...
      { icon:'⚫', name:'Reynisfjara 黑沙滩', tags:['黑沙滩','玄武岩柱'],
  ...
  day4: {
    ...
    spots: [
      { icon:'🧊', name:'Blue Ice Cave 蓝冰洞', tags:['冰洞','需向导'],
      ...
      { icon:'🚤', name:'Jökulsárlón 冰河湖', tags:['冰河湖','可搭船'],
      ...
      { icon:'💠', name:'Diamond Beach 钻石海滩', tags:['黑沙滩','浮冰'],
  ...
  day5: {
    ...
    driveSummary: { total:'约 260 km', time:'约 3小时30分钟（不含景点停留）' },
    hotel:{ name:'Garður Apartments 民宿', note:'Garður 地区公寓式民宿，邻近蓝湖与机场', map:'Gardur Apartments Iceland' },
    spots: [
      { icon:'⛪', name:'Hallgrímskirkja 大教堂', tags:['地标','登塔观景'],
        desc:'雷克雅未克的地标教堂，外形仿冰岛玄武岩柱设计，塔身高耸，登塔可俯瞰整座城市的彩色屋顶。',
        deepDesc:'哈尔格林姆教堂是雷克雅未克的地标，也是冰岛最大的教堂。它的外形设计灵感来自冰岛的玄武岩柱，塔身高达74.5米，从任何角度看都像是从地底生长出来的管风琴。登上塔顶，可以360度俯瞰雷市的彩色屋顶、远方山脉与海湾，这座城市「小而美」的格局一览无遗。',
        tips:'登塔需另外购票，建议避开正午人流高峰时段前往。',
        parking:'教堂周边路边停车。',
        toilet:'教堂内免费。',
        map:'Hallgrimskirkja Reykjavik',
        nextStop:{ type:'walk', text:'🚶 步行前往 Harpa 音乐厅', detail:'约 1.2 km · 约 15 分钟（全程下坡，途经彩虹街与主街）' } },
      { icon:'🎭', name:'Harpa 音乐厅', tags:['建筑亮点','拍照打卡'],
        desc:'外观以蜂巢状玄武岩造型玻璃幕墙为特色的音乐厅，随光线变化呈现不同色彩，是热门拍照景点。',
        deepDesc:'Harpa 音乐厅是雷克雅未克最现代的建筑地标，外观由丹麦艺术家与建筑师共同设计，蜂巢状的玻璃幕墙灵感来自冰岛的玄武岩柱。白天，阳光穿透玻璃在室内投下斑斓的光影；夜晚，建筑外墙会被点亮成不同的色彩。大厅内部免费开放，即使不听音乐会，也值得进来感受这座建筑的几何之美。记得到地下一层上个免费厕所。',
        tips:'部分公共区域可免费入内参观，也可留意当日是否有音乐会。',
        parking:'地下停车库较贵，建议步行前往或路边停车。',
        toilet:'地下一层免费，宽敞明亮。',
        map:'Harpa Reykjavik',
        nextStop:{ type:'drive', text:'🚗 前往 Blue Lagoon 蓝湖', detail:'约 50 km · 约 45 分钟' } },
      { icon:'♨️', name:'Blue Lagoon 蓝湖温泉', tags:['地热温泉','SPA'],
        desc:'世界知名地热温泉 SPA，乳白蓝色温泉水富含硅土与矿物质，据说对皮肤有舒缓效果。',
        deepDesc:'藍湖溫泉是冰岛最著名的「放松仪式」。乳白色的温泉水富含二氧化硅和矿物质，在黑色熔岩地形中显得超现实而梦幻。水温常年维持在37至39度，即使外面风雪交加，泡在温暖的蓝湖中依然舒适无比。温泉区提供硅土面膜，敷着面膜、喝着冰沙、和朋友聊天，是北欧式「慢活」的极致体验。门票建议提前在官网预订。',
        tips:'礦物質水会让头发变得极度干涩，进池前务必涂抹大量护发素；隐形眼镜不建议佩戴，改戴眼镜。务必搜索「Blue Lagoon Iceland」导航，勿搜中文「蓝湖」以免误导至废弃地热厂区。',
        parking:'温泉区停车场免费。',
        toilet:'温泉区内。',
    ...
    drives:[
      null,
      { from:'Hallgrímskirkja', to:'Harpa 音乐厅', dist:'约 1.2 km', time:'步行约 15 分钟' },
      { from:'Harpa 音乐厅', to:'Blue Lagoon', dist:'约 50 km', time:'约 45 分钟' }
    ]
  },
  day6: {
    ...
    areas: [
      {
        ...
        spots: [
          ...
          { icon:'⛪', name:'赫尔辛基大教堂（白教堂）', tags:['地标','参议院广场'],
      ...
      },
      {
        label:'B区 · 市集广场周边',
        spots: [
          { icon:'🐟', name:'市集广场 Market Square', tags:['港边市集','当地美食'],
      ...
      },
      {
        ...
        spots: [
          ...
          { icon:'🔴', name:'乌斯佩斯基大教堂（红教堂）', tags:['东正教','地标'],
      ...
      },
      {
        label:'D区 · 岩石教堂',
        spots: [
          { icon:'🪨', name:'岩石教堂（Temppeliaukio Church）', tags:['地标','岩洞教堂'],
      ...
      },
      {
        ...
        spots: [
          { icon:'🏊', name:'Allas Sea Pool', tags:['海景泳池','桑拿'],
