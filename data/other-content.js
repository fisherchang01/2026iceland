    ...
    <div class="tool-editor-section" style="margin-bottom: 24px;">
      ...
      <div style="padding: 16px; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); border-radius: 12px; margin-bottom: 12px; box-shadow: 0 4px 12px rgba(245, 87, 108, 0.3);">
        <div style="display: flex; align-items: center; justify-content: space-between;">
          ...
          <button class="tool-open-btn" onclick="window.open('./tools/travel-editor-v2.html', 'travel-editor', 'width=1400,height=900,resizable=yes')" style="margin: 0; white-space: nowrap; background: white; color: #f5576c; font-weight: 700;">開啟編輯器</button>
        </div>
      </div>
      ...
      <div style="padding: 16px; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border-radius: 12px; margin-bottom: 12px; box-shadow: 0 4px 12px rgba(79, 172, 254, 0.3);">
        <div style="display: flex; align-items: center; justify-content: space-between;">
          ...
          <button class="tool-open-btn" onclick="window.open('./tools/other-editor-v2.html', 'other-editor', 'width=1400,height=900,resizable=yes')" style="margin: 0; white-space: nowrap; background: white; color: #00f2fe; font-weight: 700;">開啟編輯器</button>
        </div>
      </div>
    </div>
