      ...
      <div class="travel-collapse-body">
        ...
        <div class="travel-sub-collapse">
          ...
          <div class="travel-sub-body">
            <a class="link-card" href="https://apps.apple.com/app/id1457810302" target="_blank" rel="noopener">
              <div class="link-icon">📲</div>
              <div class="link-info"><h4>Hello Aurora</h4><p>极光出现前 20–90 分钟推播提醒</p></div>
              <div class="link-badge">App Store ↗</div>
            </a>
            <a class="link-card" href="https://swpc.noaa.gov" target="_blank" rel="noopener">
              <div class="link-icon">🛰️</div>
              <div class="link-info"><h4>NOAA SWPC</h4><p>美国太空天气预测中心，全球极光 30 分钟预报</p></div>
            </a>
            <a class="link-card" href="https://apps.apple.com/app/id673177417" target="_blank" rel="noopener">
              <div class="link-icon">🌤️</div>
              <div class="link-info"><h4>Veður（冰岛官方天气 App）</h4><p>风力、降雪、极端天气预警，更新频率高</p></div>
              <div class="link-badge">App Store ↗</div>
            </a>
          </div>
        </div>
    ...
    <div class="travel-collapse">
      ...
      <div class="travel-collapse-body">
        ...
        <div class="travel-sub-collapse">
          ...
          <div class="travel-sub-body">
            <p style="font-size:0.8rem;color:var(--sub);line-height:1.7;">预报网站：Vedur.is、AuroraForecast.is；即时推播：Hello Aurora App（极光出现前 20–90 分钟主动提醒）；天气确认：Veður App（风力、降雪、极端天气预警）。</p>
          </div>
        </div>
        <div class="travel-sub-collapse">
          <div class="travel-sub-header" onclick="toggleSubCollapse(this)">
