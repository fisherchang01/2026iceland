    ...
    "spots": [
      {
        ...
        "deepDesc": "一、{#ff0000}foss就是冰岛话「瀑布」的意思{/color}，冰岛可以说是世界上瀑布最多的地方，因为这里断崖很多，文本非常容易形成瀑布，与一些更著名的瀑布相比，这里更加宁静祥和。\n\n二、蒂芙尼蓝瀑布之所以得名，是因为瀑布所呈现的颜色接近蒂芙尼蓝——瀑布高度不高，水量集中在一个水道，水道深度也不深，刚好反射阳光后呈现出这种颜色。/n\n\n三、旧停车场「Brúará Trail」可以走三小时的荒野健行。虽然大家都叫它秘境，但说实话，现在有了新停车场之后，这里已经不算秘境了。正对着 Brúarfoss 的最佳拍摄点就是那座木桥，桥面空间略小，遇到旅行团放人的时候，要在桥上卡到位子拍空景需要一点耐心跟运气。",
      ...
      },
      {
        ...
        "deepDesc": "一、盖锡尔大喷泉（Geysir）又称冰岛大喷泉，是冰岛喷得最高也最大的间歇泉，每次喷发高度约70-80公尺，比出名的黄石公园老忠实间歇泉还多出25~50公尺。{#0066cc}不过现在处于休眠期—{/color}，它曾在20世纪中停止喷发，2000年冰岛南部地震后重新活动，但已不像早年那样规律壮观，目前多数游客很少有机会亲眼看到它完整喷发。\n\n二、{#ff0000}第二大喷泉斯特罗库间歇泉（Strokkur）目前还处于活跃期，每5~10分钟就会喷发一次{/color}，高度大约25~35公尺。Strokkur 这个名字在冰岛语中有「搅拌」的意思，位于 Haukadalur 谷地，是 Geysir 地区最活跃的一个间歇泉，也是抵达现场后会看到最多游客围着拍照的那一个。/n/n三、Geysir间歇泉的游客中心里有餐厅、逛街区、博物馆等。餐厅采开放式自由入席，有轻食料理、面包、汤品等，采光很不错；里面还有冰岛自有品牌66° North的服饰店，连冰岛的新鲜罐装空气也有卖。",
        "tips": "游客中心有免费的厕所。\n停车费1000 ISK。",
        "parking": "1000 ISK",
        "toilet": "游客中心内免费，环境不错。",
        "map": "Geysir Iceland",
