...
const TRIP = {
  ...
  day1: {
    ...
    spots: [
      ...
      { icon:'🏞️', name:'Þingvellir 辛格维利尔国家公园', label:'B', images:['thingvellir.webp','thingvellir-alt-1.webp','thingvellir-alt-2.webp','thingvellir-alt-3.webp','thingvellir-alt-4.webp','thingvellir-alt-5.webp'], tags:['世界遗产','国家公园','地质奇观','花儿与少年'],
      ...
      { icon:'💎', name:'Brúarfoss 蓝钻石瀑布', label:'C', images:['bruarfoss.webp','bruarfoss-alt-2.webp','bruarfoss-alt-3.webp','bruarfoss-alt-4.webp','bruarfoss-alt-5.webp'], tags:['瀑布','秘境'],
  ...
  day2: {
    ...
    spots: [
      ...
      { icon:'🌊', name:'Gullfoss 黄金瀑布', label:'C', images:['gullfoss.webp','gullfoss-alt-1.webp','gullfoss-alt-2.webp','gullfoss-alt-3.webp','gullfoss-alt-4.webp','gullfoss-alt-5.webp'], tags:['瀑布','必访','花儿与少年'],
      ...
      { icon:'🌀', name:'Kerið 火山口湖', label:'F', images:['kerid.webp','kerid-alt-1.webp','kerid-alt-2.webp','kerid-alt-3.webp','kerid-alt-4.webp','kerid-alt-5.webp'], tags:['火山口','湖泊'],
  ...
  day3: {
    ...
    spots: [
      { icon:'💧', name:'Seljalandsfoss', label:'A', img:'seljalandsfoss.webp', tags:['瀑布','可走入水帘后','花儿与少年'],
      ...
      { icon:'🏔️', name:'Skógafoss', label:'B', img:'skogafoss.webp', tags:['瀑布','登高观景','花儿与少年'],
      ...
      { icon:'⚫', name:'Reynisfjara 黑沙滩', label:'D', img:'reynisfjara.webp', tags:['黑沙滩','玄武岩柱','花儿与少年'],
  ...
  day5: {
    ...
    spots: [
      { icon:'⛪', name:'Hallgrímskirkja 大教堂', label:'A', img:'hallgrimskirkja.webp', tags:['地标','建筑地标'],
      ...
      { icon:'🎭', name:'Harpa 音乐厅', label:'C', img:'harpa.webp', tags:['建筑亮点','拍照打卡','花儿与少年'],
