    ...
    "spots": [
      ...
      },
      {
        ...
        "images": [
          ...
          "hel-airport-transfer-07.webp"
        ],
        "desc": "赫尔辛基机场所有登机口都在同一个航站楼内，转机步行距离短。",
        "deepDesc": "",
        "note": "",
        "map": "",
        "deepBlocks": [
          {
            "type": "text",
            "value": "{#ff0000}非申根区 ➔申根区{/color}（最常见的，例如新加坡/香港经赫尔辛基到欧洲内陆/冰島）\n如果你的最终目的地是欧洲申根国家，赫尔辛基机场就是你的目的地抵达后的第一站你必须在这里完成移民手续。\n离开飞机：跟着我走 转运航班 指标正在向前推进。\n安检：所有来自申根区外的旅客必须重新通行机场安检。\n护照核验（入境）：去边境检查柜台，移民官会检查你的护照。\n前往登机口通过检查后，进入申根航站楼区域（1-36号登机口）。请查看屏幕确认最新的登机口编号以便继续。"
          },
          {
            "type": "text",
            "value": "赫尔辛基机场分为申根区和非申根区。申根区貴賓室位于{#ff0000}22号登机口{/color}，飞往申根的航班则在50号登机口。\n芬兰航空官方贵宾室网站详细介绍了申根区贵宾室，可容纳280名宾客，并设有两间私人淋浴间。\n芬兰航空22号登机口休息室开放时间：5：30~23：30\n\n芬兰航空休息室位于安检后申根区中部，航站楼三层（=上层），20–22号登机口上方。地点极其便利，几乎所有申根区登机口都可徒步快速抵达。"
          },
          {
            "type": "text",
            "value": "芬兰航空休息室是芬兰航空在赫尔辛基机场申根区自营的雅致休息室。芬兰航空在机场共有三间休息室：这间申根区休息室、其非申根区对应休息室，以及毗邻的 Platinum Wing。在这三者中，申根区休息室最为新近，芬兰航空于2024年在现址启用。其他芬兰航空休息室均位于申根区之外。\n\n{#0066cc}旅客通过自助闸机进入休息室。旁边也有服务台可提供协助。{/color}\n\n空间大致分为四区：自助餐台周边的主厅、用餐与放松区、工作区，以及起飞前静坐的安静区。旧休息室狭长如走廊，吸引力逊色些。\n装潢带有鲜明的北欧风格与芬兰特色：木质表面、较深的色调与极简细节贯穿其间。座位选择丰富：餐桌区、扶手椅、高位工位与更静谧的角落一应俱全。插座数量格外充足，十分利于办公。"
          },
          {
            "type": "text",
            "value": "餐饮 – 早餐与饮品\n我们到达时正值早餐时段。选择包括面包、粥、沙拉、卡累利阿馅饼、酸奶、果汁和软饮等。咖啡由咖啡机供应；临近假期，台面上还有热 glögi。所有饮品（含酒精饮品）均为自助取用。\n\n菜單有一部分是採單點式的，大部分都是漢堡，有麋鹿，雞肉漢堡，人造肉漢堡等等\n嗯，你沒看錯，有麋鹿！Reindeer Burger"
          },
          {
            "type": "img",
            "src": "hel-airport-transfer-05.webp"
          },
          {
            "type": "img",
            "src": "hel-airport-transfer-03.webp"
          },
          {
            "type": "img",
            "src": "hel-airport-transfer-08.webp"
          },
          {
            "type": "img",
            "src": "hel-airport-transfer-04.webp"
          }
        ]
      }
    ]
