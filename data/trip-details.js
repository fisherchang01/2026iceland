...
const TRIP = {
  ...
  day4: {
    ...
    spots: [
      ...
      { icon:'🚤', name:'杰古沙龙冰河湖 Jökulsárlón', label:'B', img:'jokulsarlon.webp', tags:['花儿与少年','冰川'],
        ...
        nextStop:{ type:'drive', text:'🚗 前往小冰河湖 Fjallsárlón', detail:'约 15 km · 约 20 分钟' } },
  ...
  day7: {
    ...
    spots: [
      ...
      { icon:'⛪', name:'白教堂 Helsinki Cathedral', tags:[],
      ...
      { icon:'🔴', name:'红教堂 Uspenski Cathedral', tags:[],
      ...
      { icon:'🪨', name:'岩石教堂 Temppeliaukio Church', tags:[],
