  ...
  "day0": {
    ...
    "spots": [
      ...
      },
      {
        ...
        "deepDesc": "一走進 Qantas Lounge，整體氛圍非常「澳洲風」🌿木質調＋暖光燈設計，搭配大片落地窗，採光極好。\n整個空間分成三大區域：\n1️⃣ 餐飲吧檯區：提供熱食與現點現做料理。\n2️⃣ 沙發休息區：大片皮沙發與閱讀燈，非常適合長待。\n3️⃣ 酒吧區：澳航招牌紅白酒＋雞尾酒檯整齊排列。\n https://vocus.cc/article/6906e57cfd89780001616bcc\n\n在餐饮方面，澳航商务舱贵宾室提供了不少选择。除了预期的冷热自助餐和饮料选项外，还有现点现做的菜肴（包括“gua bao”）。」！ 我简直惊呆了！ ），这让我很惊讶。 用餐区也与以沙发为主的休息区分开，我觉得这里相当不错。这里用餐的人可以享受用餐，而不必与只想在VIP包厢放松的客人争抢座位。\n\n🍽️ 餐飲區亮點：炸花枝、真的神！\n\n\n必吃亮点：商务贵宾室招牌的炸花枝（Crispy Fried Calamari）外酥内嫩，极受旅客推崇。\n這間貴賓室最廣為人知的，就是那傳說中的——✨ 炸花枝（Crispy Fried Calamari） \n實測評價：\n「外酥內嫩，炸粉不油膩，熱度剛好，\n一口咬下香氣爆開，完全是水準以上的餐廳品質。」\n真的不是誇張！「為了這盤花枝，我會提早進 Lounge。\n\n有个酒吧可以点酒，酒精飲品：紅白酒外，吧檯還會有簡易調酒（Gin Tonic、Whisky Soda）\n\n小貼心是——吧檯中段有一個「冰鎮檸檬水＋小點餅乾區」，方便趕登機的旅客快速補水。",
        "note": "",
        "map": "",
        "deepBlocks": [
          {
            "type": "img",
            "src": "sin-airport-lounge-01.webp"
          },
          {
            "type": "img",
