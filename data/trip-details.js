...
const TRIP = {
  ...
  day1: {
    ...
    spots: [
      ...
      // TODO(图片)：目前没有 img/images，之后有照片时记得补上
      { icon:'🌿', name:'Þórufoss 索鲁瀑布', label:'A', tags:['瀑布','秘境'],
      ...
      { icon:'🏞️', name:'Þingvellir 辛格维利尔国家公园', label:'B', images:['thingvellir.jpg','thingvellir-alt-1.jpg','thingvellir-alt-2.jpg','thingvellir-alt-3.jpg','thingvellir-alt-4.jpg','thingvellir-alt-5.jpg'], tags:['世界遗产','国家公园','地质奇观','花儿与少年'],
      ...
      { icon:'💎', name:'Brúarfoss 蓝钻石瀑布', label:'C', images:['bruarfoss.jpg','bruarfoss-alt-2.jpg','bruarfoss-alt-3.jpg','bruarfoss-alt-4.jpg','bruarfoss-alt-5.jpg'], tags:['瀑布','秘境'],
  ...
  day2: {
    ...
    spots: [
      // TODO(图片)：目前没有 img/images，之后有照片时记得补上
      { icon:'🐴', name:'Sýðra-Langholt 马场', label:'A', tags:['冰岛马','互动体验'],
      ...
      { icon:'💦', name:'Geysir 盖锡尔地热区', label:'B', images:['geysir.jpg','geysir-alt-1.jpg','geysir-alt-2.jpg','geysir-alt-3.jpg','geysir-alt-4.jpg','geysir-alt-5.jpg'], tags:['地热','喷泉','花儿与少年'],
      ...
      { icon:'🌊', name:'Gullfoss 黄金瀑布', label:'C', images:['gullfoss.jpg','gullfoss-alt-1.jpg','gullfoss-alt-2.jpg','gullfoss-alt-3.jpg','gullfoss-alt-4.jpg','gullfoss-alt-5.jpg'], tags:['瀑布','必访','花儿与少年'],
      ...
      // TODO(图片)：目前没有 img/images，之后有照片时记得补上
      { icon:'💧', name:'Faxi 瀑布', label:'D', tags:['瀑布','免健行','秘境'],
      ...
      // TODO(图片)：目前没有 img/images，之后有照片时记得补上
      { icon:'🍅', name:'Friðheimar 番茄农场', label:'E', tags:['温室农场','特色午餐','地热','花儿与少年'],
      ...
      { icon:'🌀', name:'Kerið 火山口湖', label:'F', images:['kerid.jpg','kerid-alt-1.jpg','kerid-alt-2.jpg','kerid-alt-3.jpg','kerid-alt-4.jpg','kerid-alt-5.jpg'], tags:['火山口','湖泊'],
  ...
  day3: {
    ...
    spots: [
      { icon:'💧', name:'Seljalandsfoss', label:'A', img:'seljalandsfoss.jpg', tags:['瀑布','可走入水帘后','花儿与少年'],
      ...
      { icon:'🏔️', name:'Skógafoss', label:'B', img:'skogafoss.jpg', tags:['瀑布','登高观景','花儿与少年'],
      ...
      // TODO(图片)：目前没有 img/images，之后有照片时记得补上
      { icon:'🐦', name:'Dyrhólaey 岬角', label:'C', tags:['海角','观景台','花儿与少年'],
      ...
      { icon:'⚫', name:'Reynisfjara 黑沙滩', label:'D', img:'reynisfjara.jpg', tags:['黑沙滩','玄武岩柱','花儿与少年'],
        ...
        // 距离/时间为估算值（总表未提供），建议之后核实民宿实际地址
        nextStop:{ type:'drive', text:'🚗 前往民宿', detail:'约 70 km · 约 55 分钟（估算）' } }
    ],
    drives:[
  ...
  day4: {
    ...
    spots: [
      { icon:'🧊', name:'Blue Ice Cave 蓝冰洞', label:'A', img:'blue-ice-cave.jpg', tags:['冰洞','需向导'],
      ...
      { icon:'🚤', name:'Jökulsárlón 冰河湖', label:'B', img:'jokulsarlon.jpg', tags:['冰河湖','花儿与少年'],
      ...
      { icon:'💠', name:'Diamond Beach 钻石海滩', label:'C', img:'diamond-beach.jpg', tags:['黑沙滩','浮冰','花儿与少年'],
  ...
  day5: {
    ...
    spots: [
      { icon:'⛪', name:'Hallgrímskirkja 大教堂', label:'A', img:'hallgrimskirkja.jpg', tags:['地标','建筑地标'],
        ...
        tips:'今天会走一圈彩虹街、主街、哈帕音乐厅再折返回这里，届时可以入内参观教堂内部；正确导航请搜「Hallgrímskirkja 主入口」，避免定位到教堂后方或侧门。',
        parking:'教堂周边。',
        toilet:'教堂内免费。',
        map:'Hallgrimskirkja Reykjavik',
        nextStop:{ type:'walk', text:'🚶 沿彩虹街下坡前往购物主街', detail:'约 10 分钟' } },
      { icon:'🌈', name:'去程：彩虹街与购物主街', label:'B', tags:['购物','去程','下坡','花儿与少年'],
        desc:'从大教堂正门沿彩虹步道缓坡下行，直交汇入热闹购物主街，一路逛至旧港边的哈帕音乐厅。',
        deepDesc:'哈尔格林姆大教堂正前方就是雷克雅未克最具代表性的彩虹步道 Skólavörðustígur，这条以彩色地砖铺成的街道从教堂门口一路向下延伸，两侧林立着独立设计师品牌、手工艺品店与咖啡馆，站在教堂前望下，彩色地砖与教堂的玄武岩柱形成绝美对比，是雷市 City Walk 最经典的开场。Laugavegur 是冰岛最热闹的购物街，从彩虹街交会处开始一路向东延伸，这里有传统的 Lopapeysa 手工毛衣专卖店 Handknitting Association of Iceland、设计感十足的 Geysir 服饰、创意巧克力 Omnom、户外品牌 66°North、可爱的 Puffin 周边纪念品，以及设计感火山盐 Saltverk，建议边走边逛，不需要急着在第一间店就下手。花少团在王安宇导游日曾穿梭于这条街道，五颜六色的沿街房屋与特色橱窗，像童话小镇照进现实，节目中的他们在这里感受了冰岛设计的独特魅力，也体验了北欧慢活的购物节奏。',
        tips:'主街营业时间通常约10:00–18:00，部分设计店可能更早关门。彩虹街为下坡路段，好走但建议穿舒适鞋。',
        parking:'教堂周边路边停车或付费停车场。',
        toilet:'教堂内免费。',
        map:'Laugavegur Reykjavik',
        nextStop:{ type:'walk', text:'🚶 前往 Harpa 音乐厅', detail:'约 10 分钟' } },
      { icon:'🎭', name:'Harpa 音乐厅', label:'C', img:'harpa.jpg', tags:['建筑亮点','拍照打卡','花儿与少年'],
        ...
        toilet:'地下一层免费，宽敞明亮。',
        map:'Harpa Reykjavik',
        nextStop:{ type:'walk', text:'🚶 沿海滨、托宁湖折返大教堂', detail:'约 10 分钟' } },
      { icon:'🌊', name:'回程：海滨与托宁湖绿意线', label:'D', tags:['海滨','回程','托宁湖','花儿与少年'],
        desc:'离开哈帕音乐厅后，不走回头路，改沿旧港区海滨及托宁湖，徒步感受不同路径返回大教堂。',
        deepDesc:'哈帕音乐厅旁就是雷克雅未克的旧港区，沿着海滨步道往东走，可以看到停泊的游艇、观鲸船与渔船，这里的仓库改建为文创园区 Grandi，有 Omnom 巧克力工厂店、Farmers Market 与 Blue Lagoon 保养品店，与去程的购物氛围不同，海滨区多了一份从容与海风的气息。从旧港往内陆切，不久就会来到托宁湖（Tjörnin），这座位于市中心的湖泊是雷市的绿肺，湖畔有市政厅、冰岛大学与美术馆，湖中有许多天鹅、鸭子与海鸥，是当地人日常散步的好去处，坐在湖边长椅上看水鸟游弋，是雷市最疗愈的时刻。从托宁湖往大教堂方向走，会穿过一片保留着传统彩色木造房的小巷，这些漆成红、黄、蓝、绿的小屋是雷市最古老的建筑群之一，每一扇窗户、每一道门框都像是童话书里的插图，花少团在节目中也曾走过类似的巷弄，感受这座城市最温柔的一面。',
        tips:'海滨步道风大，建议带防风外套。托宁湖周边可顺道参观市政厅与一旁的美术馆。',
        parking:'哈帕地下停车库或路边。',
        toilet:'哈帕地下一层免费，宽敞明亮。',
        map:'Tjornin Reykjavik',
        nextStop:{ type:'drive', text:'🚗 前往 Blue Lagoon 蓝湖', detail:'约 50 km · 约 45 分钟' } },
      { icon:'♨️', name:'Blue Lagoon 蓝湖温泉', label:'E', img:'blue-lagoon.jpg', tags:['地热温泉','SPA'],
    ...
    areas: [
      {
        label:'A区 · 白教堂周边',
        spots: [
          { icon:'🚉', name:'中央车站', label:'A', img:'helsinki-central-station.jpg', tags:['交通枢纽','建筑'], isShop:true,
          ...
          { icon:'⛪', name:'赫尔辛基大教堂（白教堂）', label:'A', img:'helsinki-cathedral.jpg', tags:['地标','参议院广场'],
      ...
      },
      {
        label:'B区 · 市集广场周边',
        spots: [
          { icon:'🐟', name:'市集广场 Market Square', label:'B', img:'market-square-helsinki.jpg', tags:['港边市集','当地美食'],
      ...
      },
      {
        ...
        spots: [
          ...
          { icon:'🔴', name:'乌斯佩斯基大教堂（红教堂）', label:'C', img:'uspenski-cathedral.jpg', tags:['东正教','地标'],
      ...
      },
      {
        label:'D区 · 岩石教堂',
        spots: [
          { icon:'🪨', name:'岩石教堂（Temppeliaukio Church）', label:'D', img:'temppeliaukio-church.jpg', tags:['地标','岩洞教堂'],
      ...
      },
      {
        ...
        spots: [
          { icon:'🏊', name:'Allas Sea Pool', label:'E', img:'allas-sea-pool.jpg', tags:['海景泳池','桑拿'],
            ...
            // 后段火车时间为估算值（总表未提供）
            nextStop:{ type:'walk', text:'🚶 步行返回中央车站，转乘火车前往机场酒店取行李', detail:'步行约 5 分钟 + 火车约 30 分钟（估算），深夜乘机返港' } }
        ]
      }
    ]
  },
