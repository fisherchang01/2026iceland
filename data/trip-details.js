...
const TRIP = {
  ...
  day1: {
    ...
    spots: [
      ...
      { icon:'💎', name:'Brúarfoss 蓝钻石瀑布', label:'C', images:['bruarfoss.webp','bruarfoss-alt-2.webp','bruarfoss-alt-3.webp','bruarfoss-alt-4.webp','bruarfoss-alt-5.webp','Bruarfoss-1.webp','Bruarfoss-2.webp','Bruarfoss-3.webp','Bruarfoss-4.webp','Bruarfoss-5.webp'], tags:['瀑布','秘境'],
  ...
  day2: {
    ...
    spots: [
      { icon:'🐴', name:'Sýðra-Langholt 马场', label:'A', images:['BruHorsefarm-1.webp','BruHorsefarm-2.webp','BruHorsefarm-3.webp','BruHorsefarm-4.webp'], tags:['冰岛马','互动体验'],
      ...
      { icon:'💧', name:'Faxi 瀑布', label:'D', images:['Faxi-1.webp','Faxi-2.webp'], tags:['瀑布','免健行','秘境'],
      ...
      { icon:'🍅', name:'Friðheimar 番茄农场', label:'E', images:['Frioheimar-1.webp','Frioheimar-2.webp','Frioheimar-3.webp','Frioheimar-4.webp','Frioheimar-5.webp','Frioheimar-6.webp','Frioheimar-7.webp','Frioheimar-8.webp'], tags:['温室农场','特色午餐','地热','花儿与少年'],
      ...
      { icon:'🌀', name:'Kerið 火山口湖', label:'F', images:['kerid.webp','kerid-alt-1.webp','kerid-alt-2.webp','kerid-alt-3.webp','kerid-alt-4.webp','kerid-alt-5.webp','Kerio-1.webp','Kerio-2.webp'], tags:['火山口','湖泊'],
  ...
  day3: {
    ...
    spots: [
      ...
      { icon:'🛒', name:'Vík 镇超市采购', img:'Vík-1.webp', tags:['超市','补给'], isShop:true,
  ...
  day5: {
    ...
    spots: [
      { icon:'⛪', name:'Hallgrímskirkja 大教堂', label:'A', images:['hallgrimskirkja.webp','Hallgrímskirkja-1.webp','Hallgrímskirkja-2.webp','Hallgrímskirkja-3.webp','Hallgrímskirkja-4.webp','Hallgrímskirkja-5.webp','Hallgrímskirkja-6.webp','Hallgrímskirkja-7.webp'], tags:['地标','建筑地标'],
      ...
      { icon:'🎭', name:'Harpa 音乐厅', label:'C', images:['harpa.webp','Harpa-1.webp','Harpa-2.webp','Harpa-3.webp','Harpa-4.webp','Harpa-5.webp','Harpa-6.webp','Harpa-7.webp'], tags:['建筑亮点','拍照打卡','花儿与少年'],
      ...
      { icon:'🌊', name:'回程：海滨与托宁湖绿意线', label:'D', images:['Tjornin-1.webp','Tjornin-2.webp','Tjornin-4.webp'], tags:['海滨','回程','托宁湖','花儿与少年'],
      ...
      { icon:'♨️', name:'Blue Lagoon 蓝湖温泉', label:'E', img:'blue-lagoon.webp', tags:['地热温泉','SPA'],
  ...
  day7: {
    ...
    areas: [
      ...
      },
      {
        ...
        spots: [
          { icon:'🏊', name:'Allas Sea Pool', label:'E', img:'allas-sea-pool.webp', tags:['海景泳池','桑拿'],
