    ...
    "spots": [
      ...
      },
      {
        ...
        "deepBlocks": [
          {
            "type": "text",
            "value": "一、建议路线：车停P1停车场，以游客中心为起点，步行经过欧美板块交界、全世界最早的议会遗址、法律石 Lögberg、辛格瓦拉教堂、冰岛总理夏季官邸等景点。"
          },
          {
            "type": "text",
            "value": "將車子停在遊客中心旁的P1停車場，打算從遊客中心當作起點，步行經過全世界最早的議會遺址、法律石 Lögberg、辛格瓦拉教堂 Þingvellir Church、冰島總理夏季官邸等景點，這樣差不多可以繞一圈回到遊客中心，路程算是滿順的安排，整個走一圈，大概{#0066cc}1.5-2小時{/color}。"
          },
          {
            "type": "text",
            "value": "二、欧美板块交界：这里是欧亚板块与北美板块海平面上唯一的交会处——一边是美洲、另一边是欧洲，两大板块每年以约2.5公分的速度撕裂，形成壮观的大裂谷地貌，经过一亿多年才出现现在的大西洋。地壳长期拉张，形成一条条向外打开的裂谷，能看到明显的岩壁、高低落差和狭长谷地。阿尔曼纳峡谷（Almannagjá）从游客中心出发，沿步道下行进入这座壮观的断层峡谷，两旁高耸的岩壁即为板块交界处。"
          },
          {
            "type": "img",
          ...
          {
            "type": "text",
            "value": "三、议会遗址：最早的议会地点就在名为 Lögberg（法律石）的巨石周围，也就是插着冰岛国旗的那块巨石区域。公元930年维京人在此建立世界最早的议会之一，园区被联合国教科文组织列为世界文化遗产——这里岩壁天然形成的回音效果，让所有人都能听清演讲者的声音。法律石是法官、议员与群众「集会宣法」的讲坛，「站上这里说出的话，全冰岛人都听得到。」"
          },
          {
            "type": "img",
          ...
          {
            "type": "text",
            "value": "四、Hakið观景台：可以俯瞰整个辛格维利尔，除了远眺一望无际的山脉湖泊，还能看到建于1859年的辛格维利尔教堂，旁边的农舍则是冰岛总理夏季官邸。"
          },
          {
            "type": "img",
          ...
          {
            "type": "text",
            "value": "五、黄金大裂缝 Silfra：阿尔曼纳陡崖高30米，Silfra裂缝能见度达100米，议会湖存有全球唯一的天然鳟鱼种群。Silfra是被冰川融水经过地下熔岩过滤30~100年后所填满的大裂缝，是世界上唯一可以在两个板块（欧亚板块和北美板块）间潜水或浮潜的位置，因此许多人会参加「Silfra裂缝潜水」行程，由专业导游带领探索。"
          },
          {
            "type": "text",
            "value": "六、延伸景点──奥克萨瀑布（Öxarárfoss）：沿步道往北，或开车到P2停车场，可到达隐藏在裂缝峡谷间、落差约13米的小巧瀑布，虽不算最厉害，但小而美、乾净清澈，值得顺路拍照。/n/n七、黃金圈天氣真的都很好，國家公園裡面景點很多也很大，全部走一圈快一點大概一個小時，慢慢走慢慢拍可以停留兩小時，風景很美"
          }
        ]
      },
      {
