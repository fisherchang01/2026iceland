...
const TRIP = {
  ...
  day1: {
    ...
    spots: [
      { icon:'🏞️', name:'Þingvellir 辛格维利尔国家公园', img:'thingvellir.jpg', tags:['世界遗产','国家公园','地质奇观'],
      ...
      { icon:'💦', name:'Geysir 盖歇尔地热区', img:'geysir.jpg', tags:['地热','喷泉'],
      ...
      { icon:'🌊', name:'Gullfoss 黄金瀑布', img:'gullfoss.jpg', tags:['瀑布','必访'],
  ...
  day2: {
    ...
    spots: [
      { icon:'💎', name:'Brúarfoss 蓝钻石瀑布', img:'bruarfoss.jpg', tags:['瀑布','秘境'],
      ...
      { icon:'🌀', name:'Kerið 火山口湖', img:'kerid.jpg', tags:['火山口','湖泊'],
  ...
  day5: {
    ...
    spots: [
      { icon:'⛪', name:'Hallgrímskirkja 大教堂', img:'hallgrimskirkja.jpg', tags:['地标','登塔观景'],
